...
# (cliSessionId 259a107f-b203-409e-b9f4-b240d931cb0b, "Coding session",
# started 2026-07-12).
#
# This session's first-ever navigation was https://www.xmind.works, which
# turned out to be a dead/error-page domain -- so it got permanently frozen
# into chromeAllowedDomains, and app.xmind.com (the real XMind app) is now
# hard-denied for the rest of this session's life.
#
...
SESSION_FILE="/Users/billkratochvil/Library/Application Support/Claude/claude-code-sessions/f0e02dda-0b33-4522-973a-300e5c0f7f2c/ad25cfaa-9030-40d7-8573-cda9334bf0e9/local_4fd647b4-cf05-443e-a06c-c4254791150a.json"
